...
export const Skills = () => {
  ...
  return (
    <>
      <section
        id="skills"
        className="flex min-h-screen scroll-mt-16 flex-col items-center justify-center bg-slate-200 p-8 lg:p-16 dark:bg-gray-900"
      >
        ...
        <div className="grid grid-cols-2 gap-6 px-4 md:grid-cols-4 xl:grid-cols-8">
          <div className="flex flex-col items-center rounded-lg border bg-white p-4 shadow-md transition-transform duration-300 hover:scale-105 hover:border-yellow-500 hover:bg-gray-100 hover:shadow-yellow-600 dark:bg-gray-800 hover:dark:bg-gray-700">
            <h3 className="text-md mb-2 text-gray-800 lg:text-lg dark:text-gray-200">
              Python
            </h3>
